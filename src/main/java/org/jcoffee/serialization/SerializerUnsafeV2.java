...
public class SerializerUnsafeV2<T> implements SerializerUnsafeI<T> {
    ...
    public SerializerUnsafeV2(Class<T> tClass) {
        this.tClass = tClass;
...
//                    declaredFieldsValues[i] = Utils.bytesFromShort(UnsafeMemory.getPrimitiveShort(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getPrimitiveInBytes(obj, declaredFieldsOffsets[i], JAVA_SHORT_SIZE);
                    break;
                case JAVA_INT_TYPE:
//                    declaredFieldsValues[i] = Utils.bytesFromInt(UnsafeMemory.getPrimitiveInt(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getPrimitiveInBytes(obj, declaredFieldsOffsets[i], JAVA_INTEGER_SIZE);
                    break;
                case JAVA_LONG_TYPE:
//                    declaredFieldsValues[i] = Utils.bytesFromLong(UnsafeMemory.getPrimitiveLong(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getPrimitiveInBytes(obj, declaredFieldsOffsets[i], JAVA_LONG_SIZE);
                    break;
...
//                    declaredFieldsValues[i] = Utils.bytesFromInt(Float.floatToRawIntBits(UnsafeMemory.getPrimitiveFloat(obj, declaredFieldsOffsets[i])));
                    declaredFieldsValues[i] = UnsafeMemory.getPrimitiveInBytes(obj, declaredFieldsOffsets[i], JAVA_FLOAT_SIZE);
                    break;
...
//                    declaredFieldsValues[i] = Utils.bytesFromLong(Double.doubleToRawLongBits(UnsafeMemory.getPrimitiveDouble(obj, declaredFieldsOffsets[i])));
                    declaredFieldsValues[i] = UnsafeMemory.getPrimitiveInBytes(obj, declaredFieldsOffsets[i], JAVA_DOUBLE_SIZE);
                    break;
...
//                    declaredFieldsValues[i] = Utils.byteFromBoolean(UnsafeMemory.getPrimitiveBoolean(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getPrimitiveInBytes(obj, declaredFieldsOffsets[i], JAVA_BOOLEAN_SIZE);
                    break;
                case JAVA_CHAR_TYPE:
//                    declaredFieldsValues[i] = Utils.bytesFromChar(UnsafeMemory.getPrimitiveChar(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getPrimitiveInBytes(obj, declaredFieldsOffsets[i], JAVA_CHARACTER_SIZE);
                    break;
...
//                    declaredFieldsValues[i] = Utils.bytesFromShort(UnsafeMemory.getShortFieldValue(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getShortFieldValueInBytes(obj, declaredFieldsOffsets[i]);
                    break;
...
//                    declaredFieldsValues[i] = Utils.bytesFromInt(UnsafeMemory.getIntegerFieldValue(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getIntegerFieldValueInBytes(obj, declaredFieldsOffsets[i]);
                    break;
...
//                    declaredFieldsValues[i] = Utils.bytesFromLong(UnsafeMemory.getLongFieldValue(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getLongFieldValueInBytes(obj, declaredFieldsOffsets[i]);
                    break;
...
//                    declaredFieldsValues[i] = Utils.bytesFromInt(Float.floatToRawIntBits(UnsafeMemory.getFloatFieldValue(obj, declaredFieldsOffsets[i])));
                    declaredFieldsValues[i] = UnsafeMemory.getFloatFieldValueInBytes(obj, declaredFieldsOffsets[i]);
                    break;
...
//                    declaredFieldsValues[i] = Utils.bytesFromLong(Double.doubleToRawLongBits(UnsafeMemory.getDoubleFieldValue(obj, declaredFieldsOffsets[i])));
                    declaredFieldsValues[i] = UnsafeMemory.getDoubleFieldValueInBytes(obj, declaredFieldsOffsets[i]);
                    break;
...
//                    declaredFieldsValues[i] = Utils.byteFromBoolean(UnsafeMemory.getBooleanFieldValue(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getBooleanFieldValueInBytes(obj, declaredFieldsOffsets[i]);
                    break;
...
//                    declaredFieldsValues[i] = Utils.bytesFromChar(UnsafeMemory.getCharFieldValue(obj, declaredFieldsOffsets[i]));
                    declaredFieldsValues[i] = UnsafeMemory.getCharFieldValueInBytes(obj, declaredFieldsOffsets[i]);
                    break;
